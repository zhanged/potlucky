...
$(function() {
  ...
  $('input[name="gather[tilt]"]:checked', '#new_gather').val()



  $('input[name="gather[wait_hours]"]:checked', '#new_gather').val()



  $(function() {
    $( "#radio_tilt" ).buttonset();
  });



  $(function() {
    $( "#radio_wait" ).buttonset();
  });



  $(function() {
    $( ".radio_activity_1" ).buttonset();
  });



  $(function() {
    $( ".radio_activity_2" ).buttonset();
  });



  $(function() {
    $( ".radio_activity_3" ).buttonset();
  });



  $(function() {
    $( ".radio_date_1" ).buttonset();
  });



  $(function() {
    $( ".radio_date_2" ).buttonset();
  });



  $(function() {
    $( ".radio_date_3" ).buttonset();
  });
  ...
  $(function() {
    $( ".radio_time_1" ).buttonset();
  });



  $(function() {
    $( ".radio_time_2" ).buttonset();
  });



  $(function() {
    $( ".radio_time_3" ).buttonset();
  });



  $(function() {
    $( ".radio_location_1" ).buttonset();
  });



  $(function() {
    $( ".radio_location_2" ).buttonset();
  });



  $(function() {
    $( ".radio_location_3" ).buttonset();
  });
...
$( document ).ready(function() {
  ...
  randomstring = "bloon.us/" + randomstring
  document.getElementById('gen_link').value = randomstring;
}); 
